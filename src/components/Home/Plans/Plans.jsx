...
const Plans = () => {
    ...
    return (
        <div className="my-10">
           <h1 className="text-3xl text-center text-[#7B1FA2]">Our <span className="text-2xl text-indigo-700">
			...
			<div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
				<div className="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-gray-100">
					<div className="space-y-2">
						<h4 className="text-2xl font-bold">Free for</h4>
						<span className="text-6xl font-bold">1 Month</span>
					</div>
					<p className="mt-3 leadi dark:text-gray-400">Premium Individual.</p>
					<ul className="flex-1 mb-6 dark:text-gray-400">
						...
						<li className="flex mb-2 space-x-2">
							...
							<span>15 hours/month of visiting time from our premium subscribe category</span>
						</li>
					</ul>
			...
			<div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
				<div className="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-violet-400 dark:text-gray-900">
					<div className="space-y-2">
						...
						<span className="text-6xl font-bold">$25
					...
					<ul className="flex-1 space-y-2">
						...
						<li className="flex items-center space-x-2">
							...
							<span>15hours/month of visiting time from our premium subscribe category(plan manager only)</span>
						</li>
					</ul>
			...
			<div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
				<div className="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-gray-100">
					<div className="space-y-2">
						...
						<span className="text-6xl font-bold">$75
							<span className="text-sm tracki">/month</span>
						</span>
					</div>
					...
					<ul className="space-y-2 dark:text-gray-400">
						...
						<li className="flex items-start space-x-2">
							...
							<span>Block explicit News</span>
						</li>
						<li className="flex items-start space-x-2">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="flex-shrink-0 w-6 h-6 dark:text-violet-400">
								<path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path>
							</svg>
							<span>Access to Premium News</span>
						</li>
						<li className="flex items-start space-x-2">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="flex-shrink-0 w-6 h-6 dark:text-violet-400">
								<path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path>
					...
					<a rel="noopener noreferrer" href="#" className="inline-block w-full px-5 py-3 font-semibold  text-center rounded dark:bg-violet-400 dark:text-gray-900">Get Started</a>
				</div>
			</div>
		</div>
	</div>
