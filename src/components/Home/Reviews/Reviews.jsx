...
const Reviews = () => {
  ...
  return (
    <div className="my-10">
      ...
      <h1 className="text-3xl text-center text-[#7B1FA2]">Viewer <span className="text-2xl text-indigo-700">
          ...
          <div className="flex flex-col items-center w-full">
            ...
            <div className="flex flex-col w-full">
              <textarea
                rows="3"
                placeholder="Message..."
                className="p-4 rounded-md resize-none border"
              ></textarea>
              <button
                type="button"
                className="py-4 my-8 font-semibold rounded-md text-white dark:bg-[#7B1FA2]"
              >
                Leave feedback
              </button>
            </div>
