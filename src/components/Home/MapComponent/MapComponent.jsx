...
<section className="py-6 ">
	<div className="container mx-auto flex flex-col justify-around p-4 text-center md:p-10 lg:flex-row">
		<div className="flex flex-col justify-center lg:text-left">
			<p className="mb-1 text-sm font-medium tracki uppercase dark:text-violet-400">Download APP,Stay with World NEWS stay update with world.</p>
			<h1 className="py-2 text-3xl font-medium leadi title-font">World NEWS Platform</h1>
		</div>
