...
const markers = [
  {
    id: 1,
    name: "Dhaka",
    position: { lat: 23.810332, lng: 90.4125181 },
  },
  {
    id: 2,
    name: "Tangail",
    position: { lat: 24.3955, lng: 89.9208 },
  },
  {
	id: 2,
	name: "Rangamati",
	position: { lat: 22.5296, lng: 92.1969 },
  }
];
...
const MapComponent = () => {
  ...
  const { isLoaded } = useLoadScript({
    googleMapsApiKey: "AIzaSyDoiuSKAwiMJWsxUk1sC5VeUh9YAAZPdfg",
  });
	...
	<div style={{ height: "90vh", width: "100%" }}>
        {isLoaded ? (
          <GoogleMap
            ...
            mapContainerStyle={{ width: "96%", height: "90vh" , margin: "0 auto"}}
          >
		...
		<div className="container mx-auto flex flex-col justify-around p-4 text-center md:p-10 lg:flex-row">
          <div className="flex flex-col justify-center lg:text-left">
            <p className="mb-1 text-sm font-medium tracki uppercase dark:text-violet-400">
              Download APP,Stay with World NEWS stay update with world.
            </p>
...
// AIzaSyDoiuSKAwiMJWsxUk1sC5VeUh9YAAZPdfg
