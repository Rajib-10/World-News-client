...
const options = {
  chart: {
    ...
    subtitle: "users,articles, publishers,and premiumArticles total collection"
  }
}
        ...
        <div className="container grid grid-cols-1 gap-6 mx-auto sm:grid-cols-2 xl:grid-cols-4">
          <div className="flex justify-center p-4 space-x-4 rounded-lg md:space-x-6 dark:bg-gray-900 dark:text-gray-100">
            ...
            <div className="flex  flex-col justify-center align-middle">
              <p className="text-3xl text-center font-semibold leadi">{data?.users}</p>
          ...
          <div className="flex justify-center p-4 space-x-4 rounded-lg md:space-x-6 dark:bg-gray-900 dark:text-gray-100">
            ...
            <div className="flex flex-col justify-center align-middle">
              <p className="text-3xl text-center font-semibold ">{data?.publishers}</p>
          ...
          <div className="flex justify-center p-4 space-x-4 rounded-lg md:space-x-6 dark:bg-gray-900 dark:text-gray-100">
            ...
            <div className="flex flex-col justify-center align-middle">
              <p className="text-3xl text-center font-semibold ">{data?.articles}</p>
          ...
          <div className="flex justify-center p-4 space-x-4 rounded-lg md:space-x-6 dark:bg-gray-900 dark:text-gray-100">
            ...
            <div className="flex flex-col justify-center align-middle">
              <p className="text-3xl text-center font-semibold ">{data?.premiumArticles}</p>
